...
public class Menghitung_Pajak extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(bReset);
        bReset.setBounds(320, 400, 72, 23);
    ...
    // Di sini, Anda dapat menulis logika untuk menyimpan data sesuai kebutuhan
    // Contoh: Menyimpan data ke dalam database atau file
    // ...
    ...
    String jumlahKendaraanText = txtJumlahKendaraan.getText();

    // Check if any of the fields is empty
    if (nama.isEmpty() || pekerjaan.isEmpty() || gajiText.isEmpty() || jumlahKendaraanText.isEmpty()) {
        JOptionPane.showMessageDialog(this, "Semua harus diisi terlebih dahulu!", "Peringatan", JOptionPane.WARNING_MESSAGE);
        return;
    }

    double gaji = Double.parseDouble(gajiText);
    int jumlahKendaraan = Integer.parseInt(jumlahKendaraanText);

    // Melakukan perhitungan pajak sesuai ketentuan
    double pajak;
    if (gaji >= 10_000_000 && jumlahKendaraan <= 3) {
        ...
        pajak = 0.0; // Pajak default jika tidak memenuhi ketentuan di atas
    }

    // Menampilkan total pajak ke dalam JTextField
